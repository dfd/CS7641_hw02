...
def run_analysis():
    with open('./nn_output/neural_network8_nn_results_dict.pkl', 'rb') as f:
    ...
    plt.savefig('./nn_plots/lr_total_fitness_curve.png')
    ...
    plt.savefig('./nn_plots/lr_zoom_fitness_curve.png')
    ...
    plt.legend()
    plt.plot()
    plt.savefig('./nn_plots/lr_time_ba.png')
    #plt.show()
    ...
    plt.legend()
    plt.plot()
    plt.savefig('./nn_plots/lr_time_f1.png')
    plt.show()
