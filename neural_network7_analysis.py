...
def run_analysis():
    with open('./nn_output/neural_network7_nn_results_dict.pkl', 'rb') as f:
    ...
    plt.savefig('./nn_plots/' + STEM + '_nn_total_fitness_curve.png')
    ...
    plt.savefig('./nn_plots/' + STEM + '_nn_zoom_fitness_curve.png')
