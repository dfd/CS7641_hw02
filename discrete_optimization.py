...
def run_experiments(problems):
    ...
    for problem in problems:
        for exp_id, experiment in enumerate(prob_dict['experiments']):
            ...
            plt.savefig('./plots/end_fitness_by_run_' + file_join([problem, exp_id]) + '.png')
            plt.clf()
    ...
    for problem in problems:
        for exp_id, experiment in enumerate(prob_dict['experiments']):
            ...
            plt.legend(loc='lower right')
            plt.savefig('./plots/fitness_curves_' + file_join([problem, exp_id]) + '.png')
            plt.clf()
    ...
    for problem in problems:
        ...
        for exp_id, experiment in enumerate(prob_dict['experiments']):
            ...
            plt.legend()
            plt.savefig('./plots/time_iterations_' + file_join([problem, exp_id]) + '.png')
    ...
    for problem in problems:
        for exp_id, experiment in enumerate(prob_dict['experiments']):
            ...
            plt.legend()
            plt.savefig('./plots/fitness_time_' + file_join([problem, exp_id]) + '.png')
